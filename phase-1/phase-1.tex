...
\chapter{معرفی}
    ...
    معرفی جامع و تکمیلی در سند \lr{Business Case}، در فصل \ref{business-case} آورده شده است.
    
\chapter{مدل تجاری \lr{(Business Case)}}\label{business-case}
سند \lr{Business Case} به صورت یک فایل \lr{PDF} جداگانه نوشته شده، اما در این سند هم به طور کامل آورده شده تا براحتی به آن دسترسی داشته باشید. برای دسترسی به فایل جداگانه‌ی \lr{Business Case} به آدرس:
\begin{flushleft}
...
قالب بارش فکری که در \lr{Confluence} نوشته شده در اینجا آورده شده است. برای دسترسی به فایل جداگانه به آدرس:
\begin{flushleft}
